...
<head>
  ...
  <title>Acceso prohibido – <?= esc($podcastTitle) ?></title>
...
<body>
  <div class="container">
    ...
    <main class="card" style="text-align:center;padding:3.5rem 2rem;">
      ...
      <h2 style="font-family:var(--font-display);font-size:clamp(1.2rem,4vw,1.6rem);margin:.75rem 0 .6rem;">Acceso prohibido</h2>
      <p style="color:var(--muted);margin:0 auto;max-width:38ch;">El contenido al que estás tratando de acceder está prohibido y no tienes permiso para verlo.</p>
